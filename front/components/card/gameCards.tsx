    ...
    return <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        ...
        return <div key = {index} className="group overflow-hidden rounded-xl border border-zinc-200 bg-white shadow-sm transition hover:-translate-y-0.5 hover:shadow-md">
            ...
            <div className = "mt-4 flex items-center justify-end gap-2">
                ...
                <button onClick={() => {props.onDelete(game.id)}}
                        className="inline-flex items-center justify-center rounded-lg border border-red-200 bg-red-50 px-3 py-1.5 text-xs font-semibold text-red-700 shadow-sm transition hover:bg-red-100 focus:outline-none focus:ring-2 focus:ring-red-400">
